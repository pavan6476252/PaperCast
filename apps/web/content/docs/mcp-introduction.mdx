...
Unlike traditional AI coding tools that write files to a codebase, the PaperCast MCP Server acts as a remote control WebSocket hub.

When you open the PaperCast playground in your browser, the website connects to this MCP server over a local WebSocket.
