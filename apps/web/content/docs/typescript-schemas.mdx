...
Because FormCast relies heavily on JSON for its document definition, maintaining strict TypeScript types is critical for ensuring the builder, engine, and JSON editor stay in sync.

The core type definitions live in `@formcast/core/src/schema.ts`.
