...
FormCast supports interactive form elements that are typically used when the generated document is meant to be filled out digitally or printed as a physical form.
