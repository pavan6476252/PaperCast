...
Layout widgets are the invisible backbone of any FormCast document. They do not render any text or graphics themselves, but rather act as containers that position and align the actual content widgets (like Text and Images).

FormCast's layout engine is heavily inspired by CSS Flexbox.
