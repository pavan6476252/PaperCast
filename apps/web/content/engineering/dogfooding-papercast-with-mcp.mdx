...
Next up: we're planning a feature to allow third parties to embed the PaperCast playground via an iframe on their own sites, enabling seamless cross-origin schema injection! Stay tuned.
