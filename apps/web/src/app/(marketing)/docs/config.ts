    ...
    pages: [
      {
        ...
        description: "A complete tour of the visual builder UI.",
      },
      {
        id: "keyboard-shortcuts",
        title: "Keyboard Shortcuts",
        description: "Global keyboard shortcuts and toolbar reference.",
      },
      {
        id: "adding-widgets",
      ...
      },
      {
        ...
        description: "Using the property panel to style your nodes.",
      },
    ],
  },
  {
    ...
    pages: [
      {
        ...
        description: "Controlling how your content breaks across pages.",
      },
      {
        id: "data-binding",
        title: "Data Binding",
    ...
    pages: [
      {
        ...
        description: "Row, Column, Spacer, and Divider.",
      },
      {
        id: "content-widgets",
        title: "Content Widgets",
        description: "Text, RichText, and Image.",
      },
      {
        id: "list-and-table-widgets",
        title: "Lists & Tables",
        description: "Ordered, Unordered, and Data Tables.",
      },
      {
        id: "form-widgets",
        title: "Form Controls",
        description: "Checkboxes, Radios, and RadioGroups.",
      },
    ],
  },
  {
    ...
    pages: [
      ...
      {
        id: "rendering-context",
        title: "Rendering Context",
        description: "React context bridging the UI and PDF generation.",
      },
      {
        id: "calculations-and-logic",
        title: "Calculations & Logic",
        description: "How variables, math, and templates are resolved.",
      },
      {
        id: "node-registry",
        title: "Node Registry",
        description: "How components are decoupled and registered.",
      },
      {
        id: "widget-system",
        title: "Widget System",
        description: "DnD widgets, basic nodes, and rich text architecture.",
      },
      {
        id: "headers-and-footers",
        title: "Headers & Footers",
        description: "Dynamic page header and footer injection.",
      },
      {
      ...
      },
      {
        ...
        description: "Zustand store for AST and validation.",
      },
      {
        id: "property-panel",
      ...
      },
      {
        ...
        description: "Safe structural and property edits on the JSON state.",
      },
      {
        id: "json-editor",
        title: "JSON Editor",
        description: "Monaco integration and real-time schema validation.",
      },
      {
        id: "templates-and-test-data",
        title: "Templates & Test Data",
        description: "How to manage and add showcase templates.",
      },
      {
        id: "documentation-site",
        title: "Documentation Site",
        description: "How this marketing and docs site works.",
      },
    ],
  },
  {
