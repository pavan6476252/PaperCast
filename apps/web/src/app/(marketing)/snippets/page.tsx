    ...
    <div className="flex flex-col md:flex-row flex-1 overflow-hidden h-[calc(100vh-4rem)]">
      ...
      <aside className="w-full md:w-72 shrink-0 border-r border-slate-200 bg-white p-6 overflow-y-auto">
        <div className="flex items-center gap-2 mb-8">
          ...
          <h2 className="text-xl font-bold text-slate-900">Schema Library</h2>
        </div>
              ...
              return (
                <li key={category.id} className="relative group">
                  ...
                  >
                    ...
                    <span
                      className={`text-[10px] font-bold px-1.5 py-0.5 rounded-full ${isActive ? "bg-white text-slate-900 shadow-sm" : "bg-slate-100 text-slate-500 group-hover:bg-white"}`}
                    >
                      {count}
                    </span>
                  </button>
      ...
      <main className="flex-1 flex flex-col p-4 md:p-8 overflow-hidden bg-slate-50/50">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 pr-2">
          ...
          <div className="relative w-full sm:w-72 shrink-0">
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 text-sm border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white shadow-sm"
            />
        ...
        <div className="w-full flex-1 overflow-y-auto pr-2 pb-8">
          {filteredSnippets.length > 0 ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center h-64 text-slate-400 bg-white rounded-2xl border border-slate-200 shadow-sm border-dashed">
