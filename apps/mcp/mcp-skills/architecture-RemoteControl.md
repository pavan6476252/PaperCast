---
description: Read this to understand how the MCP server interacts with the FormCast website via WebSockets as a remote control.
---

# FormCast Architecture: Remote Control
...
The FormCast MCP Server runs locally and acts as a **WebSocket Hub**. When the user opens the FormCast playground in their browser, the website automatically dials into this MCP server.
