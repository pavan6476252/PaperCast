import { AnyNode, DataBinding, TableColumnConfig } from "@papercast/core";
      ...
      <div className="p-4 space-y-6">
        ...
        {activeTab === "styling" && (
          <>
            ...
            {(() => {
              const CustomEditor = NodeRegistry.get(
                selectedNode.type
            ...
            {!NodeRegistry.get(selectedNode.type)?.renderPropertyEditor &&
              selectedNode.type === "text" && (
                <PropertyGroup title="Text Content">
                  <div className="flex flex-col text-sm group mt-1">
                    ...
                    <textarea
                      className="w-full min-h-[100px] border border-border/80 rounded px-3 py-2 focus:outline-none focus:ring-1 focus:ring-accent bg-background text-foreground text-sm"
                      value={selectedNode.props?.literal || ""}
                      onChange={(e) =>
                        handleUpdate("props", "literal", e.target.value)
                      }
                    />
                  </div>
                  ...
                  {selectedNode.props?.isAnchor && (
                    <>
                      <StringProp
                        ...
                        onChange={(v) =>
                          handleUpdate("props", "hrefLiteral", v)
                        }
                      />
                      <StringProp
                        label="hrefBind"
