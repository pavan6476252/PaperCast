...
export const basicNodes: ComponentTypeDefinition<any>[] = [
  ...
  { type: "image", measure: () => 0, render: ImageComponent },
  { type: "spacer", measure: () => 0, render: SpacerComponent },
  { type: "listTile", measure: () => 0, render: ListTileComponent },
  { type: "richText", measure: () => 0, render: RichTextComponent },
];
