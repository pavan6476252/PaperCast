...
Because headers and footers take up physical space on the printed page, their height is subtracted from the `availableHeight` when paginating the main body content.
</Callout>
