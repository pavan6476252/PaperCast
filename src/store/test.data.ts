import { BaseNode, BoxModel, ColumnNode, DocumentSchema, ImageNode, RowNode, SpacerNode, TableColumnConfig, TableNode, TextNode, TypographyAndColor } from "@/types/schema";
                ...
                "root": {
                    ...
                    "children": [
                        ...
                        },
                        {
                            ...
                            "type": "text",
                            "props": {
                                "literal": "Thank you for your business. Please include the invoice number when making payment."
                            },
                            "style": {
                                "textAlign": "center",
                                "fontSizePx": 10,
                    ...
                    "children": [
                        {
                            ...
                            "children": [
                                ...
                                },
                                {
                                    ...
                                    "type": "text",
                                    "props": {
                                        "literal": "{{customer.billingAddress.city}}, {{customer.billingAddress.state}}"
                                    },
                                    "layout": {}
                                },
                                {
                        ...
                        },
                        {
                            ...
                            "children": [
                                ...
                                },
                                {
                                    ...
                                    "type": "text",
                                    "props": {
                                        "literal": "{{customer.shippingAddress.city}}, {{customer.shippingAddress.state}}"
                                    },
                                    "layout": {}
                                },
                                {
...
const tables = [5, 10, 25, 50, 100, 250];
...
_TEST_DOCUMENT.document.body.children = [
    ...
    row([
        addressBlock("Bill To", ["John Doe", "123 Billing St", "New York", "NY", "10001", "USA"]),
        addressBlock("Ship To", ["John Doe", "456 Shipping Ave", "Los Angeles", "CA", "90001", "USA"]),
    ]),
    divider(),
];
...
_TEST_DOCUMENT.data.items = [
    { index: 1, description: "Web Development Services", quantity: 80, price: "$150", amount: "$12,000" },
    { index: 2, description: "Server Hosting Setup", quantity: 1, price: "$250", amount: "$250" },
    { index: 3, description: "Monthly Support Retainer", quantity: 1, price: "$2,160", amount: "$2,160" }
];
...
if (_TEST_DOCUMENT.document.body.children) {
    for (const scenario of scenarios) {
        ...
        if (scenario.title === "Simple Invoice") {
            ...
            _TEST_DOCUMENT.document.body.children.push(createStressTable(scenario.rows, scenario.cols));
...
export function sectionTitle(title: string, pageBreakBefore?: boolean): TextNode {
...
export function loremParagraph(sentences = 5): TextNode {
    ...
    return paragraph(
        ...
        Array(sentences).fill(lorem).join(""),
...
export function createStressTable(
    rows: number,
    columns: number
): TableNode {
