...
import { RendererProvider } from "../components/renderer/RendererContext";

interface OffscreenMeasurerProps {
...
export const OffscreenMeasurer: React.FC<OffscreenMeasurerProps> = ({
  ...
  useLayoutEffect(() => {
    ...
    onMeasure({ headers, footers, blocks, tableRows, tableHeaders });
  }, [doc, pageWidth, onMeasure]);

  return (
    <RendererProvider data={doc.data}>
      <div
        ref={containerRef}
        style={{
          position: "absolute",
